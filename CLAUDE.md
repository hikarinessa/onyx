...
- **Phase 4 (Typed Objects & Properties):** Complete (Rust commands, context panel, quick open type: prefix)
- **Phase 4.5 (File Operations & Cache Integrity):** Next — fix stale state after rename/delete/create
