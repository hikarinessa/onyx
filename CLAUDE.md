...
└── src/
    ...
    ├── watcher.rs            #  345 lines — File watcher: batched fs:change emission, debounced reindex + rescan handling
    ├── skip.rs               #   92 lines — Folders never indexed, watched, or listed (.git, node_modules, .claude/worktrees, …)
